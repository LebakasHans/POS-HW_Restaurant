...
string swaggerTitle = "Restaurant";
...
string? connectionString = builder.Configuration.GetConnectionString("Restaurants");
...
Console.WriteLine($"******** Don't forget to comment out RestaurantsContext.OnConfiguring !");
Console.ResetColor();
builder.Services.AddDbContext<RestaurantsContext>(options => options.UseSqlServer(connectionString));
